# response-qa-harness Specification

## Purpose

Harness de evaluación read-only de la matriz QA de respuestas (`scripts/qa_response_matrix.py`):
clasifica intención/ruta, mide la fuerza del match y verifica frases prohibidas, sin mutar
estado productivo ni gastar más Groq del permitido por los límites reales.
