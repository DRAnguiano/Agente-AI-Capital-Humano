...
- `_PAID_SENSITIVE_RE` en `knowledge_orchestrator.py` (fraude/pagos sospechosos): **NO migrar**. Es una guardia de seguridad donde el costo de un falso negativo es mayor que un LLM call de verificación.
