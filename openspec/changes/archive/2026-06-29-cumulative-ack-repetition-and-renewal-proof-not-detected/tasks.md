...
- [x] 4.3 Verificación en Chatwoot real: secuencia ciudad→edad→full→licencia E (vence 3 meses)→
      "Si" al comprobante. VERIFICADO en conv 140: ack solo confirma dato nuevo por turno y
      "Si ya lo tengo" → documents.renewal_proof="si" → bot avanza a apto médico sin re-preguntar.
- [x] 4.4 Si la verificación es correcta, cerrar el change. CORRECTO — archivando.
