...
- [ ] 10b.16c **Fase 2B.3** — activar la vista en Postgres (Opción B: junto al primer consumidor) + integración reader↔planner. NO wiring en `knowledge_orchestrator` todavía (eso es cutover).
