...
# Clave para proteger endpoints internos (/ask, /orchestrate/message, /classify, /admin/*).
# Fail-closed: si está vacía, los endpoints devuelven 401. REQUERIDA en producción.
