...
def normalize_text(value: str) -> str:
    """Structural normalization only: lowercase, accent strip, punctuation→space, whitespace compact.

    Does NOT rewrite typos or infer intent. NL extraction uses LLM T=0 directly.
    Deterministic catalog lookups (domain_catalog, city aliases) use this for
    consistent key comparison.
    """
