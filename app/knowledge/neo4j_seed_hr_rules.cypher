...
UNWIND [
  ...
  // requirements
  {id:'documentos_requisitos', canonical:'documentos y requisitos', category:'faq_topic', intent:'requirements_documents', source:'02_documentos_requisitos.md', aliases:['requisitos','rekisitos','reqisitos','documento','documentos','que piden','qué piden','que documento piden','qué documento piden','que documentos piden','qué documentos piden','que documento debo subir','qué documento debo subir','que documentos debo subir','qué documentos debo subir','documento debo subir','documentos debo subir','subir documento','subir documentos','mandar documento','mandar documentos','enviar documento','enviar documentos','seguir el proceso','continuar el proceso','para seguir el proceso','para continuar el proceso','ocupan','okupan','licencia','lic','apto','medico','médico','cartas laborales','cartas','sello','logotipo','vencida','vencido','renovarla','vigente']},
