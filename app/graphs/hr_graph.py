...
def _legacy_payload(*, channel: str, channel_user_id: str, username: str | None, phone: str | None, message: str, external_message_id: str | None) -> dict[str, Any]:
...
def _knowledge_payload(*, channel: str, channel_user_id: str, username: str | None, phone: str | None, message: str, external_message_id: str | None) -> dict[str, Any]:
    result = knowledge_handle_message(
        {
            "channel": channel,
            "channel_user_id": channel_user_id,
            "username": username,
    ...
    result.setdefault("selected_route", result.get("route") or result.get("selected_route") or "knowledge_orchestrator")
    result["graph"] = {
        "enabled": False,
...
def run_hr_graph_message(*, channel: str, channel_user_id: str, message: str, username: str | None = None, phone: str | None = None, external_message_id: str | None = None) -> dict[str, Any]:
    mode = _graph_mode()
